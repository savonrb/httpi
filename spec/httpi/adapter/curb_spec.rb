...
unless RUBY_PLATFORM =~ /java/
  ...
  describe HTTPI::Adapter::Curb do
    ...
    describe "#request(:post)" do
      ...
      it "returns a valid HTTPI::Response" do
        adapter.request(:post, basic_request).should match_response(:body => Fixture.xml)
      end
    end
    ...
    describe "#request(:post)" do
      it "sends the body in the request" do
        ...
        adapter.request(:post, basic_request { |request| request.body = 'xml=hi&name=123' } )
      end
    end
    ...
    describe "#request(:put)" do
      ...
      it "returns a valid HTTPI::Response" do
        adapter.request(:put, basic_request).should match_response(:body => Fixture.xml)
      end
    end
    ...
    describe "#request(:put)" do
      it "sends the body in the request" do
        ...
        adapter.request(:put, basic_request { |request| request.body = 'xml=hi&name=123' } )
      end
    end
    ...
    describe "#request(:custom)" do
      it "raises a NotSupportedError" do
        expect { adapter.request(:custom, basic_request) }.
